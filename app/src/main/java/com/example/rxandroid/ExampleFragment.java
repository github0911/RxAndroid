...
import com.example.rxandroid.model.AppInfo;
import com.example.rxandroid.model.AppInfoRich;
...
public class ExampleFragment extends Fragment {
    ...
    @BindView(R.id.list)
    RecyclerView list;
    @BindView(R.id.swipe_contanier)
    SwipeRefreshLayout swipeContanier;
